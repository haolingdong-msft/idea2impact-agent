...
def resolve_job_source(page_dir, args):
    if not args.job_id or args.asset_sheet_source:
        return
    jobs = read_json(page_dir / "imagegen-jobs.json", default={"jobs": []})
...
""",
    ...
    resolve_job_source(page_dir, args)
